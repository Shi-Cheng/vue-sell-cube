...
import { toLoadFavorite, toSaveFavorite } from '../../api/storage'
...
export default {
  ...
  created () {
    this.favorite = toLoadFavorite(this.seller.id, KEY, false)
  },
  data () {
    return {
      favorite: false,
  ...
  methods: {
    toggleFavorite () {
      ...
      toSaveFavorite(this.seller.id, KEY, this.favorite)
    }
  }
}
</script>
